  ...
  function buildPropertyDefaultValue(property) {
    ...
    function buildUIConf(property) {
        ...
        if (property && property.ui) {
            // if (property.ui.control)
            //     conf.control = property.ui.control;
            //
            // if (property.ui.group)
            //     conf.group = property.ui.group;
            //
            // if (property.ui.order)
            //     conf.order = property.ui.order;
